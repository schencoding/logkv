...
public class QueryProcessingStatistics implements Serializable {
	...
	private long totalNumOfRecords = 0;
	...
	public void setTruStatistics(TreeMap<Long, TRUProcessingStatistics> truStatistics) {
		this.truStatistics = truStatistics;
	}

	public long getTotalNumOfRecords() {
		return totalNumOfRecords;
	}

	public void setTotalNumOfRecords(long totalNumOfRecords) {
	...
	public String toString() {
		return "QueryProcessingStatistics [runningTime=" + runningTime + ", totalNumOfRecords=" + totalNumOfRecords + ", truStatistics=" + truStatistics
				+ ", ingestKVStatistics=" + ingestKVStatistics + "]";
	}
