...
public class QueryResponse extends Response {
	...
	public String toString() {
		return "QueryResponse [columnNames=" + Arrays.toString(columnNames) + ", columnIds=" + Arrays.toString(columnIds) + ", resultSet="
				+ Arrays.toString(resultSet) + ", runningStatistics=" + runningStatistics + "]";
	}
